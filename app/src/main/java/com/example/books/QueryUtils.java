...
public class QueryUtils {
     ...
     */
    public static ArrayList<Book>  extracItemsFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i=0; i<bookArray.length(); i++)
            {
                ...
                String subtitle  = S_EMPTY;
                String title = S_EMPTY;
                String publisher = S_EMPTY;
                String publishedDate = S_EMPTY;
    ...
    public static List<Book> fetchBookData(String requestUrl) {
        ...
        List<Book> books = extracItemsFromJson(jsonResponse);
